...
export class NscaleService {
    ...
    async generateResponse(systemInstructions: string, summary: string, recentMessages: { role: 'user' | 'assistant', content: string }[]): Promise<string> {
    ...
    async updateSummary(currentSummary: string, newMessages: { role: 'user' | 'assistant', content: string }[]): Promise<string> {
        const messages: OpenAI.Chat.Completions.ChatCompletionMessageParam[] = [
    ...
    async generateAnswerFromKnowledge(prompt: string, context: string): Promise<string> {
        const messages: OpenAI.Chat.Completions.ChatCompletionMessageParam[] = [
